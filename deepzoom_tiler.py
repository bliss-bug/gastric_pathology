...
class DeepZoomImageTiler(object):
    ...
    def __init__(self, dz:DeepZoomGenerator, basename, target_levels, mag_base, format, associated, queue):
        self._dz = dz
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', type=str, default='GPI', help='Dataset name')
